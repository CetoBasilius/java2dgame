	...
	public void update(Collisionable object1, Collisionable object2) {
		if(object1!=object2) {
			if(CollisionEngine.getInstance().circularObjectsCollide(object1, object2)) {
				...
				System.out.println(angleBetweenBothObjects);
...
//				object1.updateCollision();
				...
				//object1.setHorizontalVelocity(CollisionEngine.getInstance().getLastCollisionDepth()[0]);
				//object1.setVerticalVelocity(CollisionEngine.getInstance().getLastCollisionDepth()[1]);
